...
<section class="relative z-0 -mt-[80px] min-h-[90vh] flex items-center justify-center overflow-hidden bg-black">
  ...
  <div class="relative z-10 text-center px-5 sm:px-8 md:px-12 lg:px-24 pt-36 pb-20 md:pt-44 md:pb-28">
    <div class="reveal inline-flex items-center gap-3 px-4 py-2 bg-white/15 backdrop-blur-sm rounded-full border border-white/30 mb-6">
      ...
      <span class="text-white/85 text-sm font-medium tracking-wider">WHY OUTSOURCE</span>
    </div>
  ...
  <!-- Bottom fade into next section (white) -->
</section>
  ...
  <div class="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 lg:px-20">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
      <div class="reveal-left">
        ...
        <h2 class="font-['Plus_Jakarta_Sans'] text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[1.1] tracking-[-0.02em] text-[#111] mb-8">
          Telemarketing &<br>
        ...
        <div class="flex flex-wrap gap-3">
          <span class="px-4 py-2 bg-gray-100 border border-[#ceff66]/50 rounded-full text-sm text-gray-700 hover:bg-[#ceff66] hover:text-black transition-all duration-300 cursor-default">Outbound Calls</span>
          <span class="px-4 py-2 bg-gray-100 border border-[#ceff66]/50 rounded-full text-sm text-gray-700 hover:bg-[#ceff66] hover:text-black transition-all duration-300 cursor-default">Inbound Support</span>
          <span class="px-4 py-2 bg-gray-100 border border-[#ceff66]/50 rounded-full text-sm text-gray-700 hover:bg-[#ceff66] hover:text-black transition-all duration-300 cursor-default">Chat Support</span>
          <span class="px-4 py-2 bg-gray-100 border border-[#ceff66]/50 rounded-full text-sm text-gray-700 hover:bg-[#ceff66] hover:text-black transition-all duration-300 cursor-default">Virtual Assistants</span>
          <span class="px-4 py-2 bg-gray-100 border border-[#ceff66]/50 rounded-full text-sm text-gray-700 hover:bg-[#ceff66] hover:text-black transition-all duration-300 cursor-default">Back-Office Solutions</span>
        </div>
      </div>
...
<section class="relative py-32 bg-gray-50 overflow-hidden" id="benefits">
  ...
  <div class="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 lg:px-20 relative z-10">
    <div class="text-center mb-20">
      ...
      <h2 class="font-['Plus_Jakarta_Sans'] text-5xl md:text-6xl lg:text-7xl font-extrabold text-[#111] mb-6">
        Six <span class="text-[#ceff66]">powerful</span><br>
        reasons to partner
      </h2>
      <p class="text-gray-500 text-lg max-w-2xl mx-auto">Lower costs, better management, and greater agility — all in one strategic partnership.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div class="benefit-card-modern group relative bg-white rounded-[32px] p-8 border border-gray-200 hover:border-[#ceff66] shadow-lg hover:shadow-xl transition-all">
        <div class="absolute top-6 right-6 text-6xl font-bold text-gray-100">01</div>
        ...
        <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold text-[#111] mb-3">Serious Savings</h3>
        <p class="text-gray-500 text-sm leading-relaxed">A lower cost structure and reduced operating costs bolster your competitive advantage, allowing you to focus funds on core items.</p>
      </div>

      <div class="benefit-card-modern group relative bg-white rounded-[32px] p-8 border border-gray-200 hover:border-[#ceff66] shadow-lg hover:shadow-xl transition-all">
        <div class="absolute top-6 right-6 text-6xl font-bold text-gray-100">02</div>
        <div class="w-16 h-16 bg-[#ceff66] rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
          <i class="fas fa-users-gear text-2xl text-black"></i>
        </div>
        <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold text-[#111] mb-3">Flexible Staffing</h3>
        <p class="text-gray-500 text-sm leading-relaxed">Outsourcing makes it easy to bring in expert resources for seasonal or cyclical operations — scale up or down on demand.</p>
      </div>

      <div class="benefit-card-modern group relative bg-white rounded-[32px] p-8 border border-gray-200 hover:border-[#ceff66] shadow-lg hover:shadow-xl transition-all">
        <div class="absolute top-6 right-6 text-6xl font-bold text-gray-100">03</div>
        <div class="w-16 h-16 bg-[#ceff66] rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
          <i class="fas fa-star text-2xl text-black"></i>
        </div>
        <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold text-[#111] mb-3">Excellent Management</h3>
        <p class="text-gray-500 text-sm leading-relaxed">OneStop's highly trained team brings high-calibre management skills to the table — for a much lower price tag than in-house hires.</p>
      </div>

      <div class="benefit-card-modern group relative bg-white rounded-[32px] p-8 border border-gray-200 hover:border-[#ceff66] shadow-lg hover:shadow-xl transition-all">
        <div class="absolute top-6 right-6 text-6xl font-bold text-gray-100">04</div>
        <div class="w-16 h-16 bg-[#ceff66] rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
          <i class="fas fa-shield-halved text-2xl text-black"></i>
        </div>
        <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold text-[#111] mb-3">Continuity & Risk</h3>
        <p class="text-gray-500 text-sm leading-relaxed">In industries with high employee turnover, outsourcing with OneStop provides continuity, consistency, and peace of mind.</p>
      </div>

      <div class="benefit-card-modern group relative bg-white rounded-[32px] p-8 border border-gray-200 hover:border-[#ceff66] shadow-lg hover:shadow-xl transition-all">
        <div class="absolute top-6 right-6 text-6xl font-bold text-gray-100">05</div>
        <div class="w-16 h-16 bg-[#ceff66] rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
          <i class="fas fa-bolt text-2xl text-black"></i>
        </div>
        <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold text-[#111] mb-3">Greater Agility</h3>
        <p class="text-gray-500 text-sm leading-relaxed">Having a support infrastructure in place makes it easier to deal with change — and stay decisively ahead of the competition.</p>
      </div>
  ...
  <div class="max-w-7xl mx-auto px-5 sm:px-8 md:px-12 lg:px-20">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div class="reveal d1 text-center group">
        ...
        <div class="text-gray-500 text-sm uppercase tracking-wider">Client Retention</div>
      ...
      <div class="reveal d2 text-center group">
        ...
        <div class="text-gray-500 text-sm uppercase tracking-wider">Global Clients</div>
        <div class="w-0 group-hover:w-20 h-0.5 bg-[#ceff66] mx-auto mt-4 transition-all duration-500"></div>
      </div>
      <div class="reveal d3 text-center group">
        ...
        <div class="text-gray-500 text-sm uppercase tracking-wider">Coverage</div>
        <div class="w-0 group-hover:w-20 h-0.5 bg-[#ceff66] mx-auto mt-4 transition-all duration-500"></div>
      </div>
      <div class="reveal d4 text-center group">
        ...
        <div class="text-gray-500 text-sm uppercase tracking-wider">Custom Solutions</div>
        <div class="w-0 group-hover:w-20 h-0.5 bg-[#ceff66] mx-auto mt-4 transition-all duration-500"></div>
      </div>
    </div>
  </div>
...
<section class="relative py-32 bg-gray-50 overflow-hidden">
  ...
  <div class="max-w-4xl mx-auto px-5 text-center relative z-10">
    ...
    <p class="font-['Plus_Jakarta_Sans'] text-3xl md:text-4xl lg:text-5xl font-bold text-[#111] leading-[1.2] mb-8">
    ...
    <div class="flex items-center justify-center gap-4">
      ...
      <div class="text-left">
        <div class="font-semibold text-[#111]">Founder & CEO</div>
        <div class="text-gray-500 text-sm">OneStop Solutions</div>
      </div>
    </div>
  </div>
</section>
