...
<head>
  ...
  <style>
    ...
    .stack-eyebrow::before { content: ''; display: block; width: 28px; height: 2px; background: #4f9eff; flex-shrink: 0; }
...
<div id="scroll-progress"
     ...
     class="fixed top-0 left-0 w-0 h-[3px] bg-[#4f9eff] z-[9999] duration-100 shadow-[0_0_10px_rgba(79,158,255,0.6)]"></div>
...
<section
    ...
    <div class="absolute inset-0 z-0">
      <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=2070&auto=format&fit=crop"
           alt="Diverse team of BPO professionals collaborating in modern office environment"
  ...
  <!-- ════════════════════════════════════════
       CORE VALUES — Desktop sticky scroll (Blue theme)
  ════════════════════════════════════════ -->
  <section
