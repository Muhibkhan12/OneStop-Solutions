...
<head>
  ...
  <script type="application/ld+json">
  {
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": [
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Inbound Call Centre Services" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Outbound Telemarketing" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Lead Generation" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Customer Quality Services" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Digital Marketing" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Web Development" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Survey Research" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Winback Programs" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Technical Support Outsourcing" } }
      ]
    }
  }
  </script>
  ...
  <script type="application/ld+json">
  {
    ...
    "inLanguage": "en",
    "isPartOf": { "@type": "WebSite", "url": "https://www.onestopsolutions.com.pk/", "name": "One Stop Solutions" },
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.onestopsolutions.com.pk/" }
      ]
    }
  }
  </script>
  ...
  <style>
    ...
    *,*::before,*::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .brand-item { display:inline-flex; align-items:center; gap:14px; padding:0 32px; flex-shrink:0; opacity:.4; transition:opacity .35s; cursor:default; }
    .brand-item:hover { opacity:1; }
    .brand-name { font-family:'Space Grotesk',sans-serif; font-size:1rem; font-weight:700; color:#fff; letter-spacing:-.01em; white-space:nowrap; }
    ...
    .card-content {
      ...
      padding:1.5rem; color:white; text-shadow:0 2px 4px rgba(0,0,0,.3);
    }
...
<div class="relative w-full min-h-screen flex flex-col bg-neutral-900 pt-16 md:pt-0">
  ...
  <section
    ...
    class="w-full bg-white py-14 sm:py-20 md:py-28 lg:py-36 px-5 sm:px-8 md:px-12 lg:px-20 overflow-hidden relative"
    itemscope itemtype="https://schema.org/AboutPage">

    <div class="hidden xl:block absolute left-16 top-28 w-px h-64 bg-gradient-to-b from-transparent via-[#ceff66]/30 to-transparent pointer-events-none" aria-hidden="true"></div>
    <div class="hidden xl:block absolute top-44 right-24 w-40 h-[3px] bg-[#ceff66] rounded-full opacity-70 pointer-events-none" aria-hidden="true"></div>
      ...
      <div class="flex flex-col lg:flex-row items-center gap-10 md:gap-14 lg:gap-20">
        ...
        <div class="w-full lg:w-1/2">
          <div class="reveal flex items-center gap-3 mb-4">
            <span class="w-7 h-px bg-[#ceff66]" aria-hidden="true"></span>
          ...
          <h2 class="reveal d1 font-['Space_Grotesk'] font-bold leading-[1.12] tracking-[-0.025em] text-[#111] mb-5"
              style="font-size:clamp(1.7rem,4vw,3.1rem)">
  ...
  <section
    ...
    <!-- Hidden text list for SEO crawlers (visually hidden) -->
    <ul style="position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;" aria-hidden="true">
      <li>Argosy BPO</li><li>TEK BUZZ</li><li>Gateway Merchant Capital</li>
      <li>Virgo</li><li>Click Millions</li><li>CanNet</li>
  ...
  <section
    ...
    class="w-full bg-white py-14 sm:py-20 md:py-28 lg:py-36 px-5 sm:px-8 md:px-12 lg:px-20 relative overflow-hidden">

    <div class="absolute -top-12 -right-12 w-64 h-64 bg-[#ceff66]/10 rounded-[48px] rotate-[25deg] pointer-events-none z-0" aria-hidden="true"></div>
    ...
    <div class="max-w-[1440px] mx-auto relative z-10">
      ...
      <!-- Service Cards — h3 headings for proper hierarchy -->
      <div class="card-grid" role="list">
        ...
        <article class="reveal d1 service-card-modern" role="listitem" itemscope itemtype="https://schema.org/Service">
          ...
          <div class="card-content">
            <div class="icon-wrapper" aria-hidden="true"><div class="icon-dot"></div><i class="fas fa-headset"></i></div>
        ...
        <article class="reveal d3 service-card-modern" role="listitem" itemscope itemtype="https://schema.org/Service">
          ...
          <div class="card-overlay" aria-hidden="true"></div>
          <div class="card-content">
            <div class="icon-wrapper" aria-hidden="true"><div class="icon-dot"></div><i class="fas fa-filter"></i></div>
        ...
        <article class="reveal d1 service-card-modern" role="listitem" itemscope itemtype="https://schema.org/Service">
          ...
          <div class="card-overlay" aria-hidden="true"></div>
          <div class="card-content">
            <div class="icon-wrapper" aria-hidden="true"><div class="icon-dot"></div><i class="fas fa-star"></i></div>
        ...
        <article class="reveal d2 service-card-modern" role="listitem" itemscope itemtype="https://schema.org/Service">
          ...
          <div class="card-overlay" aria-hidden="true"></div>
          <div class="card-content">
            <div class="icon-wrapper" aria-hidden="true"><div class="icon-dot"></div><i class="fas fa-bullhorn"></i></div>
        ...
        <article class="reveal d3 service-card-modern" role="listitem" itemscope itemtype="https://schema.org/Service">
          ...
          <div class="card-overlay" aria-hidden="true"></div>
          <div class="card-content">
            <div class="icon-wrapper" aria-hidden="true"><div class="icon-dot"></div><i class="fas fa-laptop-code"></i></div>
        ...
        <article class="reveal d1 service-card-modern" role="listitem" itemscope itemtype="https://schema.org/Service">
          ...
          <div class="card-overlay" aria-hidden="true"></div>
          <div class="card-content">
            <div class="icon-wrapper" aria-hidden="true"><div class="icon-dot"></div><i class="fas fa-chart-pie"></i></div>
        ...
        <article class="reveal d2 service-card-modern" role="listitem" itemscope itemtype="https://schema.org/Service">
          ...
          <div class="card-overlay" aria-hidden="true"></div>
          <div class="card-content">
            <div class="icon-wrapper" aria-hidden="true"><div class="icon-dot"></div><i class="fas fa-redo-alt"></i></div>
        ...
        <article class="reveal d3 service-card-modern" role="listitem" itemscope itemtype="https://schema.org/Service">
          ...
          <div class="card-overlay" aria-hidden="true"></div>
          <div class="card-content">
            <div class="icon-wrapper" aria-hidden="true"><div class="icon-dot"></div><i class="fas fa-tools"></i></div>
  ...
  <section
    ...
    class="w-full bg-[#f4f3f0] py-16 md:py-28 px-5 sm:px-8 md:px-12 lg:px-20">
    ...
    <div class="max-w-[1440px] mx-auto">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-14 text-center">
        <div class="reveal d1">
          ...
          <div class="w-10 h-1 bg-lime-400 mx-auto mt-3" aria-hidden="true"></div>
        </div>
        <div class="reveal d2">
  ...
  <section
    ...
    class="w-full bg-white py-16 md:py-32 px-5 sm:px-8 md:px-12 lg:px-20"
    ...
    <div class="max-w-[1440px] mx-auto">
      <div class="flex flex-col lg:flex-row gap-10 lg:gap-20 items-start lg:items-center">
        ...
        <div class="reveal-left lg:w-1/2 w-full">
          <div class="lime-marker" aria-hidden="true"></div>
          <h2 class="font-bold tracking-[-0.025em] leading-tight font-['Space_Grotesk']"
              style="font-size:clamp(1.75rem,5vw,3.75rem)">
            Client relationships <span class="bg-lime-400 px-2 text-black">built</span> on every call, chat &amp; email
          </h2>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide" itemprop="itemListElement" itemscope itemtype="https://schema.org/Review">
                <div class="testimonial-card relative" itemscope itemtype="https://schema.org/Review">
                  ...
                  <blockquote itemprop="reviewBody">
                    <p class="text-base sm:text-lg md:text-xl leading-relaxed relative z-10 font-['Inter']">"One Stop Solutions handles our overflow inbound calls with genuine care. Their agents actually listen &mdash; our NPS jumped 22 points."</p>
                  </blockquote>
                  <div class="flex items-center gap-2 mt-6">
                    <span class="text-lime-400 text-sm" aria-label="5 out of 5 stars">&#9733;&#9733;&#9733;&#9733;&#9733;</span>
                    <span class="text-gray-400 text-xs font-['Inter']">(5.0)</span>
                  </div>
                  <p class="text-xs sm:text-sm text-gray-400 mt-3 border-t border-gray-100 pt-3 font-['Inter']" itemprop="author">&mdash; Maria G., client success lead</p>
                </div>
              </div>
              ...
              <div class="swiper-slide" itemprop="itemListElement" itemscope itemtype="https://schema.org/Review">
                <div class="testimonial-card relative">
                  <i class="fa-solid fa-asterisk text-3xl font-bold text-lime-300 opacity-40 absolute top-5 right-5" aria-hidden="true"></i>
                  <blockquote itemprop="reviewBody">
                    <p class="text-base sm:text-lg md:text-xl leading-relaxed relative z-10 font-['Inter']">"The data verification and survey research services gave us clean, actionable insights. They're a true extension of our team."</p>
                  </blockquote>
                  <div class="flex items-center gap-2 mt-6">
                    <span class="text-lime-400 text-sm" aria-label="5 out of 5 stars">&#9733;&#9733;&#9733;&#9733;&#9733;</span>
                    <span class="text-gray-400 text-xs font-['Inter']">(5.0)</span>
                  </div>
                  <p class="text-xs sm:text-sm text-gray-400 mt-3 border-t border-gray-100 pt-3 font-['Inter']" itemprop="author">&mdash; James K., market intelligence</p>
                </div>
              </div>
              ...
              <div class="swiper-slide" itemprop="itemListElement" itemscope itemtype="https://schema.org/Review">
                <div class="testimonial-card relative">
                  ...
                  <p class="text-xs sm:text-sm text-gray-400 mt-3 border-t border-gray-100 pt-3 font-['Inter']" itemprop="author">&mdash; Lena Schmidt, COO &middot; nexVent</p>
                </div>
              </div>
  ...
  <section
    ...
    class="w-full bg-[#faf9f7] py-12 md:py-28 px-5 sm:px-8 md:px-12 lg:px-20">
    ...
    <div class="max-w-[1440px] mx-auto">
      <div class="reveal bg-black text-white rounded-2xl md:rounded-3xl px-5 py-14 sm:px-8 sm:py-16 md:p-16 lg:p-24 relative overflow-hidden">
        <div class="absolute -right-10 -top-10 w-48 md:w-64 h-48 md:h-64 bg-lime-400/10 rounded-full blur-3xl pointer-events-none" aria-hidden="true"></div>
        <div class="absolute -left-10 -bottom-10 w-36 md:w-48 h-36 md:h-48 border-4 border-lime-400/20 rounded-full pointer-events-none" aria-hidden="true"></div>
        <div class="relative z-20 max-w-3xl">
          ...
          <div class="mt-8 md:mt-12 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 md:gap-6">
            <a href="contact.php"
               class="btn-primary inline-flex items-center justify-center gap-3 rounded-full px-7 py-4 text-base md:text-lg font-semibold text-neutral-900 shadow-2xl"
               title="Contact One Stop Solutions BPO">
              Start a conversation <i class="fas fa-arrow-right text-sm" aria-hidden="true"></i>
            </a>
            <a href="services.php"
               class="inline-flex items-center justify-center gap-2 border border-white/30 rounded-full px-7 py-4 text-base md:text-lg font-medium text-white hover:bg-white/10 transition-all font-['Inter']"
