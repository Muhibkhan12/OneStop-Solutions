  ...
  <style>
    *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
    ...
    .service-card-modern{
      ...
      min-height:340px;background:transparent
    }
    .card-bg-image{
    ...
    .icon-wrapper{position:relative;width:48px;height:48px;margin-bottom:1.5rem;display:flex;align-items:center;justify-content:center}
    ...
    .card-title{font-family:'Space Grotesk',sans-serif;font-size:1.2rem;font-weight:700;color:white;margin-bottom:.6rem;letter-spacing:-.01em;line-height:1.3}
    .card-desc{font-family:'Inter',sans-serif;font-size:.88rem;line-height:1.65;color:rgba(255,255,255,.88);margin-bottom:1.25rem;flex-grow:1}
...
<div class="relative w-full min-h-screen flex flex-col bg-neutral-900">
  ...
  <div class="relative z-20 flex-1 flex flex-col justify-center px-5 pt-8 pb-4 md:px-12 lg:px-20">
    <div class="max-w-3xl">
      ...
      <h1 class="reveal d1 text-white font-['Space_Grotesk'] font-bold tracking-[-0.025em] leading-[1.08] text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-[5.2rem]">
        Outsourcing that<br>builds real loyalty.
      </h1>
      <p class="reveal d2 text-white/65 text-base sm:text-lg mt-6 md:mt-8 max-w-md leading-relaxed font-['Inter']">
  ...
  <div class="max-w-[1440px] mx-auto">
    <div class="flex flex-col lg:flex-row items-center gap-10 md:gap-14 lg:gap-20">
      ...
      <div class="w-full lg:w-1/2">
        ...
        <h2 class="reveal d1 font-['Space_Grotesk'] text-3xl sm:text-4xl md:text-5xl font-bold leading-[1.12] tracking-[-0.025em] text-[#111] mb-5">
          Personal communication is our strongest bond.
        </h2>

        <p class="reveal d2 text-[#5a5a5a] text-base sm:text-lg leading-relaxed mb-8 max-w-xl font-['Inter']">
...
<section class="w-full bg-white py-16 sm:py-20 md:py-28 lg:py-36 px-5 sm:px-8 md:px-12 lg:px-20 relative overflow-hidden">
  ...
  <div class="max-w-[1440px] mx-auto relative z-10">
    ...
    <div class="flex flex-wrap justify-between items-end mb-14 md:mb-20 gap-8 relative z-10">
      ...
      <p class="reveal d2 max-w-xs sm:max-w-sm text-[#4a4a4a] font-['Inter'] text-base leading-relaxed border-b-2 border-[#ceff66] pb-4">
...
<!-- ════════════════════════════════════════
     STATS
════════════════════════════════════════ -->
<div class="w-full bg-[#f4f3f0] py-20 md:py-28 px-5 sm:px-8 md:px-12 lg:px-20">
  <div class="max-w-[1440px] mx-auto">
...
<!-- ════════════════════════════════════════
     TESTIMONIALS
════════════════════════════════════════ -->
<div class="w-full bg-white py-20 md:py-32 px-5 sm:px-8 md:px-12 lg:px-20">
  <div class="max-w-[1440px] mx-auto">
    <div class="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start lg:items-center">
      ...
      <div class="reveal-left lg:w-1/2 w-full">
        ...
        <h2 class="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-[-0.025em] leading-tight font-['Space_Grotesk']">
          Relationships <span class="bg-lime-400 px-2 text-black">built</span> on every call, chat &amp; email
        </h2>
        <p class="text-gray-500 text-base md:text-lg mt-6 max-w-md leading-relaxed font-['Inter']">
          A global logistics firm reduced churn by 34% after implementing our winback and quality survey programs.
        </p>
        <div class="mt-8 flex items-center gap-4">
          <div class="w-14 h-14 rounded-full overflow-hidden grayscale flex-shrink-0">
          ...
          <div>
            <p class="font-semibold font-['Space_Grotesk']">Ahmed Raza</p>
            <p class="text-sm text-gray-400 font-['Inter']">COO, TransWorld Logistics</p>
          </div>
        </div>
      </div>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="testimonial-card relative">
                <i class="fa-solid fa-asterisk text-4xl font-bold text-lime-300 opacity-40 absolute top-5 right-6"></i>
                <p class="text-lg md:text-2xl leading-relaxed relative z-10 font-['Inter']">"One Stop Solutions handles our overflow inbound with care. Their agents actually listen &mdash; our NPS jumped 22 points."</p>
                <div class="flex items-center gap-2 mt-8"><span class="text-lime-400">&#9733;&#9733;&#9733;&#9733;&#9733;</span><span class="text-gray-400 text-sm font-['Inter']">(5.0)</span></div>
                <p class="text-sm text-gray-400 mt-4 border-t border-gray-100 pt-3 font-['Inter']">&mdash; Maria G., client success lead</p>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-card relative">
                <i class="fa-solid fa-asterisk text-4xl font-bold text-lime-300 opacity-40 absolute top-5 right-6"></i>
                <p class="text-lg md:text-2xl leading-relaxed relative z-10 font-['Inter']">"The data verification and survey services gave us clean, actionable insights. They're an extension of our team."</p>
                <div class="flex items-center gap-2 mt-8"><span class="text-lime-400">&#9733;&#9733;&#9733;&#9733;&#9733;</span><span class="text-gray-400 text-sm font-['Inter']">(5.0)</span></div>
                <p class="text-sm text-gray-400 mt-4 border-t border-gray-100 pt-3 font-['Inter']">&mdash; James K., market intelligence</p>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="testimonial-card relative">
                <i class="fa-solid fa-asterisk text-4xl font-bold text-lime-300 opacity-40 absolute top-5 right-6"></i>
                <p class="text-lg md:text-2xl leading-relaxed relative z-10 font-['Inter']">"From ticketing to tech support &mdash; they cover everything. We scaled our operations without scaling headcount."</p>
                <div class="flex items-center gap-2 mt-8"><span class="text-lime-400">&#9733;&#9733;&#9733;&#9733;&#9733;</span><span class="text-gray-400 text-sm font-['Inter']">(5.0)</span></div>
                <p class="text-sm text-gray-400 mt-4 border-t border-gray-100 pt-3 font-['Inter']">&mdash; Lena Schmidt, COO &middot; nexVent</p>
              </div>
            </div>
          </div>
...
<!-- ════════════════════════════════════════
     CTA
════════════════════════════════════════ -->
<div class="w-full bg-[#faf9f7] py-16 md:py-28 px-5 sm:px-8 md:px-12 lg:px-20">
  <div class="max-w-[1440px] mx-auto">
    <div class="reveal bg-black text-white rounded-2xl md:rounded-3xl px-6 py-16 sm:px-10 md:p-16 lg:p-24 relative overflow-hidden">
      ...
      <div class="relative z-20 max-w-3xl">
        <h2 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight font-['Space_Grotesk']">
          Ready to outsource<br>without compromise?
        </h2>
        <p class="text-gray-300 text-base md:text-xl mt-5 md:mt-6 max-w-lg leading-relaxed font-['Inter']">
        ...
        <div class="mt-8 md:mt-12 flex flex-wrap gap-4 md:gap-6">
          <a href="#" class="btn-primary inline-flex items-center gap-3 rounded-full px-7 py-4 md:px-10 md:py-5 text-base md:text-xl font-semibold text-neutral-900 shadow-2xl">
            Start conversation <i class="fas fa-arrow-right text-sm"></i>
          </a>
          <a href="#" class="inline-flex items-center gap-2 border border-white/30 rounded-full px-7 py-4 md:px-10 md:py-5 text-base md:text-xl font-medium text-white hover:bg-white/10 transition-all font-['Inter']">
            Explore services
          </a>
        </div>
      </div>
