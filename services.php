...
<div class="fixed top-0 left-0 w-full z-50 bg-[rgba(15,15,15,0.92)] backdrop-blur-[14px] border-b border-white/10">
  <div class="max-w-[1440px] mx-auto flex items-center justify-between px-5 md:px-8 lg:px-12 h-16">
    <div class="flex items-center gap-2">
      <span class="font-['Plus_Jakarta_Sans'] font-bold text-xl text-white tracking-tight">OneStop<span class="text-[#ceff66]">Solutions</span></span>
    </div>
    <div class="hidden md:flex items-center gap-8 text-sm">
      <a href="index.html" class="text-white/70 hover:text-[#ceff66] transition-colors">Home</a>
      <a href="about.html" class="text-white/70 hover:text-[#ceff66] transition-colors">About</a>
      <a href="#" class="text-[#ceff66] font-medium">Services</a>
      <a href="#" class="text-white/70 hover:text-[#ceff66] transition-colors">Case Study</a>
    </div>
    <div class="flex items-center gap-4">
      <a href="#" class="hidden sm:inline-block rounded-full bg-[#ceff66] px-5 py-2 text-xs font-bold text-[#111] hover:bg-[#d4ff7a] transition">Get in touch →</a>
      <!-- mobile menu toggle -->
      <div id="menuToggle" class="md:hidden flex flex-col gap-1.5 cursor-pointer p-2">
        <span id="bar1" class="w-5 h-0.5 bg-white transition-transform"></span>
        <span id="bar2" class="w-5 h-0.5 bg-white transition-opacity"></span>
        <span id="bar3" class="w-5 h-0.5 bg-white transition-transform"></span>
      </div>
    </div>
  </div>
</div>
...
<section id="service-grid" class="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-12 lg:px-20 py-20 md:py-28 bg-[#fafafa] relative">
  ...
  <!-- service cards grid – all 9 services listed exactly -->
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
    <!-- 1. Inbound -->
    <div class="reveal service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6 shadow-md"><i class="fas fa-phone-volume text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Inbound</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">Customer care, order taking, helpdesk — we handle high‑volume inbound with empathy and efficiency.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
    <!-- 2. Outbound -->
    <div class="reveal d2 service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6"><i class="fas fa-phone-alt text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Outbound</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">Telemarketing, appointment setting, market research — proactive outreach that delivers results.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
    <!-- 3. Lead generation -->
    <div class="reveal d3 service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6"><i class="fas fa-chart-line text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Lead generation</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">Qualified, B2B & B2C leads through multi‑channel strategies that fill your pipeline.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
    <!-- 4. Customer / Quality Services -->
    <div class="reveal service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6"><i class="fas fa-headset text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Customer & quality services</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">Dedicated support, QA monitoring, and continuous improvement for superior CX.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
    <!-- 5. Digital Marketing -->
    <div class="reveal d2 service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6"><i class="fas fa-bullseye text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Digital marketing</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">SEO, PPC, social media, content — data‑driven campaigns that maximise ROI.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
    <!-- 6. Web development -->
    <div class="reveal d3 service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6"><i class="fas fa-code text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Web development</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">Custom websites, e‑commerce, portals — built for performance and conversion.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
    <!-- 7. Survey research -->
    <div class="reveal service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6"><i class="fas fa-poll text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Survey research</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">Customer feedback, market studies, data collection — actionable insights from real people.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
    <!-- 8. Winback programs -->
    <div class="reveal d2 service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6"><i class="fas fa-undo-alt text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Winback programs</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">Re‑engage lost customers, reduce churn, and recover revenue with tailored retention campaigns.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
    <!-- 9. Technical support -->
    <div class="reveal d3 service-card bg-white rounded-3xl p-8 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.15)] border border-gray-100">
      <div class="w-14 h-14 bg-[#ceff66] rounded-xl flex items-center justify-center mb-6"><i class="fas fa-laptop-code text-2xl text-[#111]"></i></div>
      <h3 class="font-['Plus_Jakarta_Sans'] text-2xl font-bold mb-3">Technical support</h3>
      <p class="text-[#5a5a5a] text-[0.95rem] leading-relaxed mb-4">Tier 1/2 support, troubleshooting, IT helpdesk — fast, reliable, and multilingual.</p>
      <span class="inline-flex items-center text-[#ceff66] text-sm font-semibold">Learn more <i class="fas fa-arrow-right ml-2 text-xs"></i></span>
    </div>
  </div>

  <!-- CTA inside section (optional) -->
  <div class="reveal text-center mt-16">
    <a href="#contact" class="inline-flex items-center gap-2 bg-[#111] text-white rounded-full px-8 py-4 text-sm font-bold hover:bg-[#ceff66] hover:text-[#111] transition-all duration-300 shadow-xl">Need a custom solution? <i class="fas fa-arrow-right text-xs"></i></a>
  </div>
</section>

<!-- ========== WHY CHOOSE US (stacked cards similar to about, but simplified) ========== -->
<div class="w-full bg-[#111] py-20 lg:py-28">
  <div class="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-12 lg:px-20">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div>
        <div class="flex items-center gap-[10px] text-[#ceff66] text-[0.7rem] font-bold tracking-[0.28em] uppercase mb-6 before:content-[''] before:block before:w-7 before:h-0.5 before:bg-[#ceff66]">
          why onestop
        </div>
        <h2 class="font-['Plus_Jakarta_Sans'] text-[clamp(2rem,4vw,3.2rem)] font-extrabold leading-[1.12] tracking-[-0.02em] text-white max-w-[520px] mb-7">
          Integrated services,<br><span class="text-[#ceff66]">proven process</span>
        </h2>
        <p class="text-[0.95rem] text-white/55 max-w-[450px] leading-[1.7] mb-8">
          We don't just execute — we integrate. Inbound, outbound, digital, and tech support work in concert to deliver seamless customer experiences.
        </p>
        <!-- stats mini -->
        <div class="flex gap-8">
          <div><span class="font-['Plus_Jakarta_Sans'] text-3xl font-bold text-[#ceff66]">98%</span><span class="block text-white/40 text-xs uppercase tracking-wider">retention</span></div>
          <div><span class="font-['Plus_Jakarta_Sans'] text-3xl font-bold text-[#ceff66]">24/7</span><span class="block text-white/40 text-xs uppercase tracking-wider">operations</span></div>
        </div>
      </div>
      <!-- right side: simple card stack effect (static on mobile) -->
      <div class="relative h-[400px] lg:h-[500px] flex items-center justify-center">
        <div class="absolute w-[280px] sm:w-[320px] lg:w-[360px] bg-[#ceff66] rounded-[32px] p-8 shadow-2xl -rotate-6 z-0 opacity-80">
          <div class="text-2xl font-bold mb-3">Inbound + Outbound</div>
          <p class="text-black/60">Unified call center solutions</p>
        </div>
        <div class="absolute w-[280px] sm:w-[320px] lg:w-[360px] bg-white rounded-[32px] p-8 shadow-2xl rotate-3 z-10 border border-gray-200">
          <div class="text-2xl font-bold mb-3">Digital + Tech</div>
          <p class="text-[#5a5a5a]">Web, marketing & support under one roof</p>
          <div class="mt-4 flex gap-2"><span class="bg-[#ceff66] px-3 py-1 text-xs rounded-full">SEO</span><span class="bg-gray-100 px-3 py-1 text-xs rounded-full">Dev</span></div>
        </div>
      </div>
    </div>
  </div>
